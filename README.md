...
Will built Qt4 version by default
...
I use Fedora 22 MinGW to build Windows versions. Furthemore I build
portable static versions. Any another build way not tested and may will
not work. It is on my TODO list.

Fedora hasn't MinGW QJSON package. You need to build your own version. It is
easy:
    ...
    make
    sudo make install # be carefull, it installs qjson to system folders
